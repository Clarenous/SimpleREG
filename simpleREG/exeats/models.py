...
class Holiday(models.Model):
    HolidayID = models.AutoField(primary_key=True, default=0)
    ...
    #def __str__(self):
        #return self.HolidayID + ' ' + self.HolidayName + ' ' + self.HolidayStartDate + ' ' + self.HolidayEndDate


class LeaveInfo(models.Model):
    holiday = models.ForeignKey(Holiday, on_delete=models.CASCADE)
    pub_date = models.DateTimeField('date published')
    LeaveInfoID = models.AutoField(primary_key=True, default=0)
